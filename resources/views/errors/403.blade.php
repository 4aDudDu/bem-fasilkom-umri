...
<div class="min-h-[80vh] flex items-center justify-center relative overflow-hidden">
    <!-- Background Accents -->
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-rose-600/10 rounded-full blur-[100px] pointer-events-none"></div>
    <div class="absolute bottom-1/4 right-1/4 w-64 h-64 bg-red-600/10 rounded-full blur-[80px] pointer-events-none"></div>

    <div class="container mx-auto px-4 text-center relative z-10" data-aos="fade-up">
        <!-- Error Number -->
        <h1 class="text-9xl md:text-[12rem] font-black tracking-tighter mb-4 text-transparent bg-clip-text bg-gradient-to-br from-rose-400 via-red-500 to-pink-600 drop-shadow-2xl">
            403
        </h1>
        
        <!-- Error Message -->
        <h2 class="text-3xl md:text-5xl font-bold mb-6 text-white">Akses Ditolak</h2>
        <p class="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Maaf, Anda tidak memiliki izin untuk mengakses halaman ini. Halaman ini mungkin khusus untuk administrator atau memerlukan hak akses khusus.
        </p>
